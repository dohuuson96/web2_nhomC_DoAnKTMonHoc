<script>
    jQuery(document).ready(function ($) {
        ...
        var TopFixMenu = $(".module-2");
        var p = $(".logo p");
        var logoa = $(".logo a");
        var a = $("ul li a");
        var b = $(".header-cta a");
        var c = $(".module-2 .social-list a");
        var menua = $(".a");
            ...
            <nav class="navbar navbar-default">
                <div class="container aa">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="http://localhost/web2/public/home"><img src="images/logo2.png" class="img-responsive"></a>
                    </div>
